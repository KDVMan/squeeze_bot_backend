...
func (object *botRouteImplementation) addCalculator() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var request models_bot.AddCalculatorRequestModel
		...
		if err := object.botService().AddCalculator(&request); err != nil {
			message := "failed to add calculator bot"
