...
type ProviderService struct {
	...
	// quoteRepositoryService         services_quote_repository_interface.QuoteRepositoryService
	// calculatorService              services_calculator_interface.CalculatorService
	// calculatorPresetService        services_calculator_preset_interface.CalculatorPresetService
